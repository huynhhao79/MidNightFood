            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('products.edit', [$product->id]) }}" method="POST" class="form"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $product->name }}" required maxlength="255" type="text" id="last-name-column"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $product->price }}" required value="10000" min="10000" max="1000000" step="1000"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea required name="description" maxlength="255" class="form-control"
                                                id="exampleFormControlTextarea1" rows="3">{{ $product->decription }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
