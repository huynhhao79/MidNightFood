            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4 class="card-title">The list staffs</h4>
                    </div>
                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ explode(", ", $item->address)[0] }}</td>
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <a href="{{ route('staffs.detail', $item->id) }}" type="button" class="btn btn-secondary">
                                                    ...
                                                    <a href="{{ route('staffs.edit.form', $item->id) }}" type="button" class="btn btn-primary">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="{{ route('staffs.delete', $item->id) }}" type="button" class="btn btn-primary ml-1">
...
<a href="{{ route('staffs.create.form') }}" class="text-light"><div class="fab add"> + </div></a>
@endsection
